...
<div class="col content-body">
    <div class="row justify-content-between m-3">
        <div class="col-2 size-12">Content Management/Tag</div>
        <div class="col-auto">
            <a href="<?= base_url('content_management/tag/add_tag') ?>" class="btn btn-primary">Add New Tag</a>
        </div>
    </div>
        ...
        <div class="table-responsive-xl">
            <table id="empTable" class="text-center table-borderless">
                ...
                foreach ($data as $item) {
                    ...
                    <tr>
                        <td id="cm"><?= $i ?></td>
                        <td id="cm"><span class="badge bg-warning"> <?= $item->tag ?> </span></td>
                        <td class="w-25" id="cm">
                            <a href="<?= base_url('content_management/tag/edit_tag/'.$item->id) ?>" class="btn btn-success size-14 mx-1 mb-1">Edit</a>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#delete').on('click', function(event) {
            ...
            $.ajax({
                url: '<?= base_url('content_management/tag/delete_tag') ?>',
                method: "POST",
                dataType: "json",
                data: {
                    'id': $('#id').val(),
